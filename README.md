...
EELDUS: ver. 1.0.3/20180918
------------------------------------------------------

ANDMEBAASI INSTALLEERIMINE:
------------------------------------------------------

KIRJELDUS: olemasolev andmebaas "hois" täiendatakse. Andmebaasi skripti on db/install20181008.sql
...
1. käivitada install20181008.sql skript, nt
   
   psql -h devhois -f install20181008.sql 2>&1 | tee log.txt
   ...
   -f install20181008.sql - install faili nimi
