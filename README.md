...
EELDUS: ver. 0.6.4/20180214
------------------------------------------------------

ANDMEBAASI INSTALLEERIMINE:
------------------------------------------------------

KIRJELDUS: olemasolev andmebaas "hois" täiendatakse. Andmebaasi skripti on db/install20180223.sql
...
1. käivitada install20180223.sql skript, nt
   
   psql -h devhois -f install20180223.sql 2>&1 | tee log.txt
   ...
   -f install20180223.sql - install faili nimi
