 ...
 *         &lt;element name="data" type="{http://producers.ehis.xtee.riik.ee/producer/ehis}kmaLopetanudAndmed" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "kmaLopetanudResponse")
public class KmaLopetanudResponse {
    ...
    protected JAXBElement<KmaLopetanudAndmed> data;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link KmaLopetanudAndmed }{@code >}
     *     
     */
    public JAXBElement<KmaLopetanudAndmed> getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(JAXBElement<KmaLopetanudAndmed> value) {
        this.data = value;
    }
