 ...
 *         &lt;element name="contentOut" type="{http://www.w3.org/2001/XMLSchema}base64Binary" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "terviseInfosusteemResponse")
public class TerviseInfosusteemResponse {

    @XmlElement(required = true)
    protected String teade;
    @XmlElement(required = true)
    protected BigInteger kood;
    protected byte[] contentOut;
     ...
     *     byte[]
     */
    public void setContentOut(byte[] value) {
