 ...
 *         &lt;element name="data" type="{http://producers.ehis.xtee.riik.ee/producer/ehis}strArray" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "laeAlusharidusV2Response")
public class LaeAlusharidusV2Response {
    ...
    protected JAXBElement<StrArray> data;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link StrArray }{@code >}
     *     
     */
    public JAXBElement<StrArray> getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(JAXBElement<StrArray> value) {
        this.data = value;
    }
