 ...
 *         &lt;element name="oppekavad" type="{http://producers.ehis.xtee.riik.ee/producer/ehis}oisOppekavad"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "oisOppekava")
public class OisOppekava {
    ...
    @XmlElement(required = true)
    protected OisOppekavad oppekavad;
     ...
     *     
     */
    public OisOppekavad getOppekavad() {
        return oppekavad;
    }
     ...
     *     
     */
    public void setOppekavad(OisOppekavad value) {
