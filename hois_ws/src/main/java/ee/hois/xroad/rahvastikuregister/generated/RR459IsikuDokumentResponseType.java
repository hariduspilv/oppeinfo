...
/**
 * <p>Java class for RR459isikuDokumentResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RR459isikuDokumentResponseType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RR459isikuDokumentResponseType", propOrder = {
    "veatekst",
    "dokumendid"
})
public class RR459IsikuDokumentResponseType
    extends XRoadResponseBaseType
{

    protected String veatekst;
    @XmlElement(required = true)
    protected RR459IsikuDokumentResponseType.Dokumendid dokumendid;
     ...
     * @return
     *     possible object is
     *     {@link RR459IsikuDokumentResponseType.Dokumendid }
     *     
     */
    public RR459IsikuDokumentResponseType.Dokumendid getDokumendid() {
        return dokumendid;
    }
     ...
     *     
     */
    public void setDokumendid(RR459IsikuDokumentResponseType.Dokumendid value) {
    ...
    public static class Dokumendid {
        ...
        protected List<RR459IsikuDokumentResponseType.Dokumendid.Dokument> dokument;
         ...
         * {@link RR459IsikuDokumentResponseType.Dokumendid.Dokument }
         * 
         * 
         */
        public List<RR459IsikuDokumentResponseType.Dokumendid.Dokument> getDokument() {
            if (dokument == null) {
                dokument = new ArrayList<RR459IsikuDokumentResponseType.Dokumendid.Dokument>();
            }
        ...
        public static class Dokument {
            ...
            protected RR459IsikuDokumentResponseType.Dokumendid.Dokument.Isikud isikud;
             ...
             * @return
             *     possible object is
             *     {@link RR459IsikuDokumentResponseType.Dokumendid.Dokument.Isikud }
             *     
             */
            public RR459IsikuDokumentResponseType.Dokumendid.Dokument.Isikud getIsikud() {
                return isikud;
            }
             ...
             *     
             */
            public void setIsikud(RR459IsikuDokumentResponseType.Dokumendid.Dokument.Isikud value) {
                this.isikud = value;
            }
            ...
            public static class Isikud {
                ...
                protected List<RR459IsikuDokumentResponseType.Dokumendid.Dokument.Isikud.Isik> isik;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link RR459IsikuDokumentResponseType.Dokumendid.Dokument.Isikud.Isik }
                 * 
                 * 
                 */
                public List<RR459IsikuDokumentResponseType.Dokumendid.Dokument.Isikud.Isik> getIsik() {
                    if (isik == null) {
                        isik = new ArrayList<RR459IsikuDokumentResponseType.Dokumendid.Dokument.Isikud.Isik>();
                    }
                    return this.isik;
                }
