...
/**
 * <p>Java class for RRs1090MeditsiinilineSunnitoendResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RRs1090MeditsiinilineSunnitoendResponseType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RRs1090MeditsiinilineSunnitoendResponseType", propOrder = {
    "ttSonum2",
    "ttSonum2A"
})
public class RRs1090MeditsiinilineSunnitoendResponseType
    extends XRoadResponseBaseType
{

    protected List<RRs1090MeditsiinilineSunnitoendResponseType.TtSonum2> ttSonum2;
    @XmlElement(name = "ttSonum2_a")
    protected List<RRs1090MeditsiinilineSunnitoendResponseType.TtSonum2A> ttSonum2A;
     ...
     * {@link RRs1090MeditsiinilineSunnitoendResponseType.TtSonum2 }
     * 
     * 
     */
    public List<RRs1090MeditsiinilineSunnitoendResponseType.TtSonum2> getTtSonum2() {
        if (ttSonum2 == null) {
            ttSonum2 = new ArrayList<RRs1090MeditsiinilineSunnitoendResponseType.TtSonum2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RRs1090MeditsiinilineSunnitoendResponseType.TtSonum2A }
     * 
     * 
     */
    public List<RRs1090MeditsiinilineSunnitoendResponseType.TtSonum2A> getTtSonum2A() {
        if (ttSonum2A == null) {
            ttSonum2A = new ArrayList<RRs1090MeditsiinilineSunnitoendResponseType.TtSonum2A>();
        }
