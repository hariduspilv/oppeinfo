...
/**
 * <p>Java class for RR449ResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RR449ResponseType"&gt;
 *   &lt;complexContent&gt;
 ...
 *                             &lt;element name="AadressiLiik" type="{http://rr.x-road.eu/producer}kdliik1"/&gt;
 *                             &lt;element name="AlatesKP" type="{http://rr.x-road.eu/producer}date"/&gt;
 *                             &lt;element name="ADS_ADR_ID" type="{http://www.w3.org/2001/XMLSchema}integer"/&gt;
 *                             &lt;element name="ADS_OID" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *                             &lt;element name="ADS_KOODAADRESS" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *                             &lt;element name="ADS_ADOB_ID" type="{http://www.w3.org/2001/XMLSchema}integer"/&gt;
 *                           &lt;/sequence&gt;
 *                         &lt;/restriction&gt;
 *                       &lt;/complexContent&gt;
 *                     &lt;/complexType&gt;
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                           &lt;sequence&gt;
 *                             &lt;element name="Liik" type="{http://rr.x-road.eu/producer}kdliik1"/&gt;
...
@XmlType(name = "RR449ResponseType", propOrder = {
    "avaldaja",
    "isikuAadressid",
    "kontaktid"
})
public class RR449ResponseType
    extends XRoadResponseBaseType
{

    @XmlElement(name = "Avaldaja", required = true)
    protected RR449ResponseType.Avaldaja avaldaja;
    @XmlElement(name = "IsikuAadressid")
    protected RR449ResponseType.IsikuAadressid isikuAadressid;
    @XmlElement(name = "Kontaktid")
    protected RR449ResponseType.Kontaktid kontaktid;
     ...
     * @return
     *     possible object is
     *     {@link RR449ResponseType.Avaldaja }
     *     
     */
    public RR449ResponseType.Avaldaja getAvaldaja() {
        return avaldaja;
    }
     ...
     *     
     */
    public void setAvaldaja(RR449ResponseType.Avaldaja value) {
        this.avaldaja = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link RR449ResponseType.IsikuAadressid }
     *     
     */
    public RR449ResponseType.IsikuAadressid getIsikuAadressid() {
     ...
     *     
     */
    public void setIsikuAadressid(RR449ResponseType.IsikuAadressid value) {
     ...
     * @return
     *     possible object is
     *     {@link RR449ResponseType.Kontaktid }
     *     
     */
    public RR449ResponseType.Kontaktid getKontaktid() {
        return kontaktid;
    }
     ...
     *     
     */
    public void setKontaktid(RR449ResponseType.Kontaktid value) {
    ...
    public static class IsikuAadressid {
        ...
        protected List<RR449ResponseType.IsikuAadressid.IsikuAadress> isikuAadress;
         ...
         * {@link RR449ResponseType.IsikuAadressid.IsikuAadress }
         * 
         * 
         */
        public List<RR449ResponseType.IsikuAadressid.IsikuAadress> getIsikuAadress() {
            if (isikuAadress == null) {
                isikuAadress = new ArrayList<RR449ResponseType.IsikuAadressid.IsikuAadress>();
            }
        ...
        public static class IsikuAadress {
            ...
            protected Kdliik1 aadressiLiik;
            @XmlElement(name = "AlatesKP", required = true)
            protected String alatesKP;
            @XmlElement(name = "ADS_ADR_ID", required = true)
            protected BigInteger adsadrid;
            @XmlElement(name = "ADS_OID", required = true)
            protected String adsoid;
            @XmlElement(name = "ADS_KOODAADRESS", required = true)
            protected String adskoodaadress;
            @XmlElement(name = "ADS_ADOB_ID", required = true)
            protected BigInteger adsadobid;
             ...
             *     
             */
            public Kdliik1 getAadressiLiik() {
                return aadressiLiik;
            }
             ...
             *     
             */
            public void setAadressiLiik(Kdliik1 value) {
             ...
             *     
             */
            public void setADSADOBID(BigInteger value) {
    ...
    public static class Kontaktid {
        ...
        protected List<RR449ResponseType.Kontaktid.Kontakt> kontakt;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link RR449ResponseType.Kontaktid.Kontakt }
         * 
         * 
         */
        public List<RR449ResponseType.Kontaktid.Kontakt> getKontakt() {
            if (kontakt == null) {
                kontakt = new ArrayList<RR449ResponseType.Kontaktid.Kontakt>();
            }
            return this.kontakt;
        }
        ...
        public static class Kontakt {
             ...
             *     
             */
            public void setLiik(Kdliik1 value) {
                this.liik = value;
            }
