 ...
 *         &lt;element name="EHISStudyLevel" type="{http://sais2.x-road.ee/producer/}SAISClassification" minOccurs="0"/&gt;
 *         &lt;element name="StudyForms" type="{http://sais2.x-road.ee/producer/}ArrayOfSAISClassification" minOccurs="0"/&gt;
 *         &lt;element name="CurriculumLanguages" type="{http://sais2.x-road.ee/producer/}ArrayOfSAISClassification" minOccurs="0"/&gt;
 *         &lt;element name="Curriculums" type="{http://sais2.x-road.ee/producer/}ArrayOfAdmissionCurriculum" minOccurs="0"/&gt;
 *         &lt;element name="StudyLocationCountry" type="{http://sais2.x-road.ee/producer/}SAISClassification" minOccurs="0"/&gt;
 *         &lt;element name="StudyLocationCity" type="{http://sais2.x-road.ee/producer/}ArrayOfKvp" minOccurs="0"/&gt;
 *         &lt;element name="AdmissionTuitions" type="{http://sais2.x-road.ee/producer/}ArrayOfAdmissionTuition" minOccurs="0"/&gt;
