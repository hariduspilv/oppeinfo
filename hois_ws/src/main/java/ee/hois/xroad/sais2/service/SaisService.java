...
public class SaisService {
    ...
    public SaisClassificationResponse classificationsExport(XRoadHeader xRoadHeader) {
        ...
        try {
            URL wsdlUrl = SaisService.class.getResource("sais3.wsdl");
            ...
            context.put("xRoadHeader", xRoadHeader);
            ...
            if(responseObject == null) {
                ...
                responseObject.setError(e.getStackTrace().toString());
                responseObject.setxRoadErrors(true);
            }
        }
