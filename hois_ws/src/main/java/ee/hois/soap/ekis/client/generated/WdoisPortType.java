...
public interface WdoisPortType {
    ...
    @WebMethod(action = "https://kis-test.hm.ee/?page=ois2_toend/registerCertificate")
    ...
    @WebMethod(action = "https://kis-test.hm.ee/?page=ois2_kaskkiri/registerDirective")
    @WebResult(name = "return", targetNamespace = "urn:ekis", partName = "return")
    ...
    @WebMethod(action = "https://kis-test.hm.ee/?page=ois2_praktika/registerPracticeContract")
    @WebResult(name = "return", targetNamespace = "urn:ekis", partName = "return")
    public Answer registerPracticeContract(
        ...
        @WebParam(partName = "ois_id", name = "ois_id")
        java.lang.String oisId,
        @WebParam(partName = "create_date", name = "create_date")
    ...
    @WebMethod(action = "https://kis-test.hm.ee/?page=ois2_kaskkiri/deleteDirective")
    @WebResult(name = "return", targetNamespace = "urn:ekis", partName = "return")
