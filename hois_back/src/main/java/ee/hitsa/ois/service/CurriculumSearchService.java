...
public class CurriculumSearchService {
    ...
    public Page<CurriculumSearchDto> search(Long usersSchool, CurriculumSearchCommand criteria, Pageable pageable) {
        return JpaQueryUtil.query(CurriculumSearchDto.class, Curriculum.class, (root, query, cb) -> {
            ...
            List<Long> curriculumSchools = getSchools(usersSchool, criteria.getSchool());
