...
public class CurriculumService {
    ...
    /**
     * TODO:
     * select count(*) from curriculum -> 377
     * Curriculum search form find all -> 287
     * (controlled in TTU, TPU, and EBS user accounts)
     * Possible reason: some rows fail validation constraints in Curriculum class
     * Presumably those values are generated by unit tests 
     */
	public Page<CurriculumForSearch> search(CurriculumSearchCommand curriculumSearchCommand, Pageable pageable) {
		...
		boolean ignoreMerCode = SearchUtil.ingoreValue(curriculumSearchCommand.getMerCode());
		...
		String merCode = SearchUtil.contains(curriculumSearchCommand.getMerCode());
		...
		List<CurriculumForSearch> list =
				curriculumRepository.search(name, ignoreByNameEt, ignoreNameEn,
						...
						code, ignoreCode, merCode, ignoreMerCode, schools, ignoreSchool,
