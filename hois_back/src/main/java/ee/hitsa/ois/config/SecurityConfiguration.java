    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/timetables/generalTimetables/**").permitAll()
                .antMatchers(HttpMethod.GET, "/timetables/groupPeriodTimetables/**").permitAll()
                .antMatchers(HttpMethod.GET, "/timetables/teacherPeriodTimetables/**").permitAll()
                .antMatchers(HttpMethod.GET, "/timetables/roomPeriodTimetables/**").permitAll()
