...
public class AutocompleteController {
    ...
    public List<AutocompleteResult> curriculumsAsList(HoisUserDetails user, CurriculumAutocompleteCommand term) {
        return autocompleteService.curriculums(user.getSchoolId(), term);
    }
