...
public class ClassifierSearchDto extends ClassifierSelection {
    ...
    public ClassifierSearchDto(String code, String nameEt, String nameEn, String nameRu, Boolean valid, Boolean higher, Boolean vocational, String mainClassCode, String value) {
        super(code, nameEt, nameEn, nameRu, valid, higher, vocational, mainClassCode, value);
    }
