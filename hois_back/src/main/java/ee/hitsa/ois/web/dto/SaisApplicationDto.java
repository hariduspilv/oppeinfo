...
public class SaisApplicationDto {
    ...
    public static SaisApplicationDto of(SaisApplication saisApplication) {
        ...
        saisApplication.getGraduatedSchools().forEach(it -> {
            dto.getGraduatedSchools().add(SaisApplicationGraduatedSchoolDto.of(it));
        });
        saisApplication.getGrades().forEach(it -> {
            dto.getGrades().add(SaisApplicationGradeDto.of(it));
        });
        saisApplication.getOtherData().forEach(it -> {
            dto.getOtherData().add(SaisApplicationOtherDataDto.of(it));
        });
        return dto;
    }
