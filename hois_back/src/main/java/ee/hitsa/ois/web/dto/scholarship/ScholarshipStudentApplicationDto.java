...
public class ScholarshipStudentApplicationDto {
    private Long id;
    @NotEmpty
    @Size(max = 50)
    ...
    public static ScholarshipStudentApplicationDto of(ScholarshipApplication application) {
        ScholarshipStudentApplicationDto dto = new ScholarshipStudentApplicationDto();
        if (application != null) {
