...
public class GeneralMessageController {
    ...
    public Page<GeneralMessageDto> search(HoisUserDetails user, GeneralMessageSearchCommand criteria, Pageable pageable) {
        return generalMessageService.search(user.getSchool().getId(), criteria, pageable).map(GeneralMessageDto::of);
    }
    ...
    public GeneralMessageDto getGeneralMessage(HoisUserDetails user, @Valid @RequestBody GeneralMessageForm form) {
        ...
        generalMessage.setSchool(user.getSchool());
    ...
    @DeleteMapping("/{id}")
    public void deleteGeneralMessage(HoisUserDetails user, @WithVersionedEntity(value = "id", versionRequestParam = "version") GeneralMessage generalMessage, @RequestParam("version") Long version) {
        assertSameSchool(user, generalMessage);
